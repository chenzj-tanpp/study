...
// 模拟通话记录的生成
	...
	public  String getCallToPhoneNumber() {
		return "1874982" + String.valueOf(new Random().nextInt(10)) + String.valueOf(new Random().nextInt(10))
...
//打印通话记录
	public void printDetails() {
		...
		for (int i = 0; i < recordArray.length; i++) {
			...
			System.out.println("通话结束时间：" + da.format(Long.parseLong(recordField[2])));
			System.out
