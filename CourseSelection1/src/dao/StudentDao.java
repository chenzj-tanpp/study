...
public class StudentDao implements IDao {
	...
	@Override
	public ArrayList delete(String studentNo) throws Exception {
		student = students.get(studentNo);
		ArrayList al=student.getSCMessage();
